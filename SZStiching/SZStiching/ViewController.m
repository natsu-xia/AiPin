...
//    resultImage = [resultImage addWaterText:@""];
//    resultImage = [resultImage addWaterImage:[UIImage imageNamed:@""] waterImageRect:CGRectMake(resultImage.size.width/2, resultImage.size.height - 300 , SCREEN_WIDTH, 300)];
